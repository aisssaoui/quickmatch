      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              text = "INSERT INTO Player (surname, first_name, mail_address, phone_number)\n\t    VALUES($1, $2, $3, $4)\n        returning *";
              values = [req.body.surname, req.body.first_name, req.body.mail_adress, req.body.phone_number];
              _context.prev = 2;
              _context.next = 5;
      ...
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 9:
              values = [req.body.surname || rows[0].surname, req.body.first_name || rows[0].first_name, req.body.mail_adress || rows[0].mail_adress, req.body.phone_number || rows[0].phone_number, req.params.id];
              _context4.next = 12;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 4:
              ...
              return _context5.abrupt("return", res.status(404).send({ message: "player not found" }));
