      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              text = "SELECT * FROM player_belong_club INNER JOIN club WHERE club = $1";
              _context2.prev = 1;
              _context2.next = 4;
              return _db2.default.query(text, [req.params.id]);
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              text = "SELECT * FROM player_belong_club INNER JOIN club WHERE player = $1";
              _context3.prev = 1;
              _context3.next = 4;
              return _db2.default.query(text, [req.params.id]);
      ...
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              text = "(SELECT club_name FROM player_belong_club P INNER JOIN club C on P.club = C.id) EXCEPT (SELECT club_name FROM player_belong_club P INNER JOIN club C on P.club = C.id WHERE player=$1)";
              _context4.prev = 1;
              _context4.next = 4;
              return _db2.default.query(text, [req.params.id]);
      ...
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              text = "INSERT INTO player_belong_club (player, club, is_admin)\n\t    VALUES($1, $2, $3)\n        returning *";
      ...
      return regeneratorRuntime.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              deleteQuery = "DELETE FROM player_belong_club WHERE player=$1 returning *";
              _context6.prev = 1;
              _context6.next = 4;
      ...
      return regeneratorRuntime.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              text = "select club, count(*) as nb from player_belong_club where club=$1 group by club ;";
              _context8.prev = 1;
              _context8.next = 4;
              return _db2.default.query(text, [req.params.id]);
            ...
            case 4:
              ...
              return _context8.abrupt("return", res.status(404).send({ message: "club not found" }));

            case 8:
              return _context8.abrupt("return", res.status(200).send(rows[0]));
