      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              text = "select m.id as meet, i.player as player, status, start_hour, end_hour, repeat_day, location, minimal_team_size, maximal_team_size from invitation i left outer join slot s on i.slot = s.id left outer join meet m on i.meet = m.id where meet=$1 ";
              _context2.prev = 1;
              _context2.next = 4;
              return _db2.default.query(text, [req.params.id]);
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              text = "select pseudo from player, (select m.id as meet, i.player as player, status, start_hour, end_hour, repeat_day, location, minimal_team_size, maximal_team_size from invitation i left outer join slot s on i.slot = s.id left outer join meet m on i.meet = m.id where meet = $1 and status = TRUE) t where t.player = id";
              _context3.prev = 1;
              _context3.next = 4;
              return _db2.default.query(text, [req.params.id]);
      ...
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              text = "select pseudo from player, (select m.id as meet, i.player as player, status, start_hour, end_hour, repeat_day, location, minimal_team_size, maximal_team_size from invitation i left outer join slot s on i.slot = s.id left outer join meet m on i.meet = m.id where meet = $1 and status = FALSE) t where t.player = id";
              _context4.prev = 1;
              _context4.next = 4;
              return _db2.default.query(text, [req.params.id]);
    ...
    var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(req, res) {
      ...
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              text = "select distinct id from invitation a, (select m.id as meet, i.player as player, status, start_hour, end_hour, repeat_day, location, minimal_team_size, maximal_team_size from invitation i left outer join slot s on i.slot = s.id left outer join meet m on i.meet = m.id where meet = $1) t where a.player = $2 and a.meet = $3";
              _context4.prev = 1;
              _context4.next = 4;
              return _db2.default.query(text, [req.params.mid, req.params.pid, req.params.mid]);
