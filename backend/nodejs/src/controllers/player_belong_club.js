      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              text = "SELECT P.id, P.surname, P.first_name, P.pseudo, PBC.is_admin FROM\n       player_belong_club PBC INNER JOIN player P ON P.id = PBC.player\n       WHERE PBC.club = $1";
              _context2.prev = 1;
              _context2.next = 4;
              return _db2.default.query(text, [req.params.id]);
  ...
  */
      ...
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              text = "SELECT * FROM player_belong_club PBC INNER JOIN club C on PBC.club = C.id WHERE PBC.player = $1";
              _context4.prev = 1;
              _context4.next = 4;
              return _db2.default.query(text, [req.params.id]);
  ...
  deletePlayerFromClub: function () {
    var _ref13 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(req, res) {
      var deleteQuery, values, _ref14, rows;
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 5:
              ...
              return _context7.abrupt("return", res.status(404).send({ message: "belonging of the player to the club not found" }));
    ...
    function deletePlayerFromClub(_x13, _x14) {
  ...
  getAll: function () {
    var _ref15 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(req, res) {
      var findAllQuery, _ref16, rows, rowCount;
