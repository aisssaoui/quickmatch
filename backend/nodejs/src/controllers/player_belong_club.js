...
var player_belong_club = {
  ...
  /**
   * Get All player_belong_club rows
   * @param {object} req
   * @param {object} res
   * @returns {object} player_belong_club array
   */
  getAllRows: (function() {
          ...
          function _callee6$(_context6) {
            while (1) {
              switch ((_context6.prev = _context6.next)) {
                case 0:
                  text =
                    "INSERT INTO player_belong_club (player, club, is_admin) VALUES($1, $2, $3) RETURNING *";
              ...
              switch ((_context7.prev = _context7.next)) {
                ...
                case 5:
                  ...
                  return _context7.abrupt(
                    "return",
                    res.status(404).send({
                      message: "belonging of the player to the club not found"
                    })
                  );
