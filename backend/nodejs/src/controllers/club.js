...
//                 case 0:
//                   findAllForOneUserQuery =
//                     "SELECT C.club_name, C.creation_date, C.private_club, PBC.is_admin FROM Club C JOIN Player_Belong_Club PBC ON C.id=PBC.club JOIN Player P ON PBC.player=P.id";
//                   _context20.prev = 1;
//                   _context20.next = 4;
