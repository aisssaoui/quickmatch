...
var Player = {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              values = [req.body.surname, req.body.first_name, req.body.mail_adress, req.body.phone_number, req.body.pseudo, req.body.mdp, req.body.avatar];
              _context.prev = 2;
              _context.next = 5;
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 4:
              ...
              return _context6.abrupt("return", res.status(202).send({ message: "player not found" }));

            case 8:
              return _context6.abrupt("return", res.status(200).send(rows[0]));

            case 11:
              _context6.prev = 11;
              _context6.t0 = _context6["catch"](1);
              return _context6.abrupt("return", res.status(202).send(_context6.t0));
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 4:
              ...
              return _context7.abrupt("return", res.status(202).send({ message: "player not found" }));
            ...
            case 11:
              ...
              return _context7.abrupt("return", res.status(202).send(_context7.t0));
   ...
   */
  update: function () {
    var _ref16 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(req, res) {
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            ...
            case 5:
              ...
              return _context9.abrupt("return", res.status(200).send({ message: "player not found" }));

            case 9:
              values = [req.body.pseudo || rows[0].pseudo, req.body.surname || rows[0].surname, req.body.first_name || rows[0].first_name, req.body.mail_address || rows[0].mail_address, req.body.phone_number || rows[0].phone_number, req.body.bio || rows[0].bio, req.body.avatar || rows[0].avatar, req.body.mdp || rows[0].mdp, req.body.is_valid === null ? rows[0].is_valid : req.body.is_valid, req.body.private_profil === null ? rows[0].private_profil : req.body.private_profil, req.params.id];
              _context9.next = 12;
              return _db2.default.query(updateOneQuery, values);

            case 12:
              response = _context9.sent;
              return _context9.abrupt("return", res.status(200).send(response.rows[0]));

            case 16:
              _context9.prev = 16;
              _context9.t0 = _context9["catch"](2);
              return _context9.abrupt("return", res.status(200).send(_context9.t0));
