...
var Player = {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 4:
              ...
              return _context5.abrupt("return", res.status(200).send({ message: "player not found" }));
            ...
            case 11:
              ...
              return _context5.abrupt("return", res.status(200).send(_context5.t0));
  ...
  getPlayerStat: function () {
    ...
    function getPlayerStat(_x13, _x14) {
        ...
        return regeneratorRuntime.wrap(
          function _callee7$(_context7) {
            ...
            case 12:
              ...
              return _context8.abrupt("return", res.status(200).send(response.rows[0]));

            case 16:
              _context8.prev = 16;
              _context8.t0 = _context8["catch"](2);
              return _context8.abrupt("return", res.status(200).send(_context8.t0));
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            ...
            case 4:
              ...
              return _context9.abrupt("return", res.status(404).send({ message: "player not found" }));

            case 8:
              return _context9.abrupt("return", res.status(204).send({ message: "deleted" }));
