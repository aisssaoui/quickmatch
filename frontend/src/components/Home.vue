<template>
  <div>
    <v-carousel cycle show-arrows hide-delimiter-background show-arrows-on-hover>
      <v-carousel-item
          ...
          <v-layout row wrap align-center>
            ...
            <v-flex v-if="i==1" class="text-center">
              <p
                ...
                style="text-shadow: 1px 1px 7px #16002d;"
              >Statistiques</p>
              <p
                class="display-1 white--text"
                style="text-shadow: 1px 1px 7px #16002d;"
              >Les statistiques de tous vos matchs</p>
              <v-btn
                to="/stat"
                large
                color="#20003c"
            ...
            <v-flex v-if="i==2" class="text-center">
              <p class="display-4 white--text" style="text-shadow: 1px 1px 7px #040083;">Matchs</p>
              <p
                class="display-1 white--text"
                style="text-shadow: 1px 1px 7px #040083;"
              >L'historique et les résultats de tous les matchs</p>
              <v-btn
                to="/match"
                large
                color="#20003c"
              ...
              <v-list-item two-line>
                <v-list-item-content>
                  <v-list-item-title>
                    ...
                    <strong>Créez des groupes</strong>
                  </v-list-item-title>
              ...
              <v-list-item two-line>
                <v-list-item-content>
                  <v-list-item-title>
                    ...
                    <strong>Proposez des horaires</strong>
                  </v-list-item-title>
              ...
              <v-list-item two-line>
                <v-list-item-content>
                  ...
                  <v-list-item-subtitle>
                    Il vous suffit juste d'accepter les invitations à des horaires qui vous conviennent et le tour est joué !
              ...
              <v-list-item two-line>
                <v-list-item-content>
                  <v-list-item-title>
                    ...
                    <strong>Consultez vos statistiques</strong>
                  </v-list-item-title>
                  <v-list-item-subtitle>Essayez d'être le meilleur en comparant vos statistiques de chaque match dans un historique complet regroupant toutes vos performances !</v-list-item-subtitle>
                </v-list-item-content>
              </v-list-item>
            </v-card>
    ...
    <v-container id="team">
      <div class="row text-center padding">
        <div class="col-12">
          <p class="headline font-weight-medium">EQUIPE</p>Composée de d'élèves de l'ENSEIRB-Matmeca, cette application gratuite a pout but d'aider les sportifs de l'INRIA et des autres universités, d'organiser leurs rencontres sportives.
        </div>
      </div>
    </v-container>
